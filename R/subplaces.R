#' Subplaces Dataset (High Resolution)
#'
#' The `subplaces_high` dataset contains
#' high-resolution spatial data for subplaces in South Africa
...
#'   geometry for each subplace, defining its boundaries
#' using the WGS84 coordinate reference system.}
#' }
#'
...
#' This dataset is approximately
#' 44.55 MB on disk and uses about 1345 MB in
#' memory due to its high-resolution geometries. For
#' applications that don't require high precision boundaries,
#' consider using the simplified
#' `subplaces` dataset instead.
#'
"subplaces_high"

#' Subplaces Dataset (Simplified)
#'
#' The `subplaces` dataset contains simplified spatial
#'  data for subplaces in South Africa
#' based on the 2011 Census.
#' This dataset includes the same attributes as `subplaces_high`
...
#' @note
#' MDB refers to the Municipal Demarcation Board of South Africa.
#' This dataset is a simplified version of `subplaces_high`,
